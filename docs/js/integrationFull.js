$(document).ready(function() {
  ...
  function getUserInfo(address) {
    ...
    contract.methods.investors(userAddress).call({from: '0xB72816d00fd5Afd8cC40423b6b078CdbeF999416'}, function(error, result) {
      ...
      contract.methods.bonusSize().call({from: '0xB72816d00fd5Afd8cC40423b6b078CdbeF999416'}, function(error, result) {
        const timeout = Math.floor(((deposit * 2) / (deposit * (result / 100))) * 10000) / 10000
        $('.user-forecast').html( timeout + ' days' )
      })
    })

    contract.methods.payoutSize(userAddress).call({from: '0xB72816d00fd5Afd8cC40423b6b078CdbeF999416'}, function(error, result) {
